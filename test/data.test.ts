import { ChainId, Token, Fetcher, WRAPPED_NATIVE_CURRENCY } from '../src'
...
describe.skip('data', () => {
  ...
  it('Pair', async () => {
    const token = new Token(ChainId.GOERLI, '0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735', 18) // DAI
    const pair = await Fetcher.fetchPairData(WRAPPED_NATIVE_CURRENCY[ChainId.GOERLI], token)
